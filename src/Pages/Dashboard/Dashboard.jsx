      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-10 pb-6 border-b border-slate-200">
          ...
          <Button
            ...
            className="text-sm font-semibold text-slate-500 hover:text-orange-600 transition-colors lowercase tracking-normal px-0"
          >
            Logout →
          </Button>
        </div>
        ...
        <div className="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm">
          ...
          <p className="text-slate-500 leading-relaxed mb-6">
            Your system is healthy and all services are running normally. You
            can manage your data and view reports from this panel.
          </p>
