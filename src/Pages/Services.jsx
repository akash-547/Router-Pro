...
const Services = () => {
  ...
  return (
    /* 1. justify-center HATA DIYA: Is se content upar se start hoga aur niche tak scroll hoga */
    <div className="bg-[#f3f4f6] min-h-screen py-20 flex flex-col">
        ...
        <div className="max-w-6xl mx-auto w-full">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {services.map((s, i) => (
              <div 
                key={i} 
                className="group bg-white p-8 rounded-3xl border border-slate-200 shadow-sm hover:shadow-2xl hover:border-orange-200 transition-all duration-300 hover:-translate-y-2 flex flex-col"
              >
